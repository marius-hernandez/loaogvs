...
$sql1="SELECT * FROM ".$section."_grade_first_first";
...
$sql2="SELECT * FROM ".$section."_grade_first_sec";
$stmt = mysqli_stmt_init($conn);
...
$sql4="SELECT * FROM ".$section."_grade_sec_first";
            $stmt = mysqli_stmt_init($conn);
            ...
            $sql5="SELECT * FROM ".$section."_grade_sec_sec";
            $stmt = mysqli_stmt_init($conn);
            ...
            $sql6="SELECT * FROM ".$section."_ave_sec";
            $stmt = mysqli_stmt_init($conn);
...
include('pdf.php');
	...
	$mail->Body = '<h1 style="text-align: center; font-family: Century Gothic">Good day! </h1><h2 style="text-align: center; font-family: Century Gothic">This is the performance of your student. Congratulations!</h2>';				//An HTML or plain text message body
