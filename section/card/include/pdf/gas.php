...
$pdf->Cell(10, 5, '', 0, 0, 'L');
$pdf->Cell(11, 5, '', 0, 1, 'L');
$pdf->Cell(20, 5, 'Gas 6', 1, 0, 'L');
$pdf->Cell(80, 5, 'Elective 1 (Pre-Calculus)', 1, 0, 'L');
$pdf->Cell(10, 5, '1', 1, 0, 'L');
$pdf->Cell(10, 5, '2', 1, 0, 'L');
$pdf->Cell(20, 5, '2', 1, 0, 'L');
$pdf->Cell(10, 5, '', 0, 0, 'L');
...
$pdf->Cell(7, 5, 'Total', 1, 0, 'C');
$pdf->Cell(11, 5, '', 0, 1, 'L');
$pdf->Cell(20, 5, 'GAS 7', 1, 0, 'L');
$pdf->Cell(80, 5, 'Applied Economics', 1, 0, 'L');
$pdf->Cell(10, 5, '1', 1, 0, 'L');
$pdf->Cell(10, 5, '2', 1, 0, 'L');
$pdf->Cell(20, 5, '2', 1, 1, 'L');
$pdf->Cell(20, 5, 'GAS 8', 1, 0, 'L');
$pdf->Cell(80, 5, 'Elective 2 (Gen. Chemistry 1)', 1, 0, 'L');
$pdf->Cell(10, 5, '1', 1, 0, 'L');
$pdf->Cell(10, 5, '2', 1, 0, 'L');
$pdf->Cell(20, 5, '2', 1, 0, 'L');
$pdf->Cell(10, 5, '', 0, 0, 'L');
$pdf->Cell(140, 5, 'VISION', 0, 1, 'C');
$pdf->Cell(20, 5, 'GAS 9', 1, 0, 'L');
