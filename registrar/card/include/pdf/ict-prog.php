...
$sql = "SELECT * FROM ".$section."_student WHERE student_first='$first' AND student_last='$last'";
...
if (!mysqli_stmt_prepare($stmt, $sqlsec)) {
    header("location: url.php?error=stmtfaileding");
    exit();
}
...
$strand = $rowsec['class_strand'];
    ...
    $sql1="SELECT * FROM ".$section."_grade_first_first WHERE student_first='$first' AND student_last='$last'";
$stmt = mysqli_stmt_init($conn);
	if (!mysqli_stmt_prepare($stmt, $sql1)) {
    header("location: url.php?error=stmtfaileds");
    exit();
}
...
$sql2="SELECT * FROM ".$section."_grade_first_sec WHERE student_first='$first' AND student_last='$last'";
$stmt = mysqli_stmt_init($conn);
...
$sql3="SELECT * FROM ".$section."_ave WHERE student_first='$first' AND student_last='$last'";
$stmt = mysqli_stmt_init($conn);
if (!mysqli_stmt_prepare($stmt, $sql3)) {
    header("location: url.php?error=stmtfailedsa");
    exit();
}
...
$ave = $row3['ave'];
    ...
    $sql4="SELECT * FROM ".$section."_grade_sec_first WHERE student_first='$first' AND student_last='$last'";
            $stmt = mysqli_stmt_init($conn);
            ...
            $sql5="SELECT * FROM ".$section."_grade_sec_sec WHERE student_first='$first' AND student_last='$last'";
            $stmt = mysqli_stmt_init($conn);
            ...
            $sql6="SELECT * FROM ".$section."_ave_sec WHERE student_first='$first' AND student_last='$last'";
            $stmt = mysqli_stmt_init($conn);
