<?php
    ...
    $sqlstudent = "SELECT * from student WHERE user_lrn='$lrn'";
            $stmt=mysqli_stmt_init($conn);
              if (!mysqli_stmt_prepare($stmt, $sqlstudent)) {
                header("location: ../abm.php?error=stmtfailed&grade=".$grade."&track=".$track."&strand=".$strand."&spec=".$spec."&section=".$section."&sem=2");
                exit();
              }
    ...
    if ($emailparent==$emailstudent) {
      header("location: ../abm.php?grade=".$grade."&track=".$track."&strand=".$strand."&spec=".$spec."&section=".$section."&sem=two&error=studentparent");
       ...
       if ($sem=1) {
        ...
        mysqli_stmt_execute($stmt);
          if ($queryResults>0) {
            ...
            mysqli_stmt_execute($stmt);
            header("location: ../abm.php?grade=".$grade."&track=".$track."&strand=".$strand."&spec=".$spec."&section=".$section."&sem=1");
          }
          else{
            ...
            mysqli_stmt_execute($stmt);
            header("location: ../abm.php?grade=".$grade."&track=".$track."&strand=".$strand."&spec=".$spec."&section=".$section."&sem=1&error=none");
        ...
        mysqli_stmt_execute($stmt);
          ...
          if (isset($_POST['parent'])) {
            ...
            header("location: ../abm.php?grade=".$grade."&track=".$track."&strand=".$strand."&spec=".$spec."&section=".$section."&sem=one&error=none&data-slide-to=1");
          }
